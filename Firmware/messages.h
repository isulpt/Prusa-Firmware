...
extern const char MSG_BED_FIND_OFFSET_AND_SKEW_LINE1[];
extern const char MSG_BED_FIND_OFFSET_AND_SKEW_LINE2[];
extern const char MSG_BED_HEATING[];
extern const char MSG_BED_LEVELING_FAILED_POINT_LOW[];
extern const char MSG_BED_MEASURE_REFERENCE_HEIGHT_LINE1[];
extern const char MSG_BED_MEASURE_REFERENCE_HEIGHT_LINE2[];
...
extern const char MSG_CRASH_DETECT[];
extern const char MSG_CRASH_DETECTED[];
extern const char MSG_ERROR[];
extern const char MSG_EXTRUDER[];
extern const char MSG_EXTRUDER_CHOOSE[];
extern const char MSG_FAN_SPEED[];
//Start: Filament related messages
extern const char MSG_FILAMENT[];
extern const char MSG_FILAMENT_CLEAN[];
extern const char MSG_FILAMENT_CHANGE[];
extern const char MSG_FILAMENT_CHOOSE[];
extern const char MSG_FILAMENT_CUT[];
extern const char MSG_FILAMENT_EJECT[];
extern const char MSG_FILAMENT_LOAD[];
extern const char MSG_FILAMENT_LOADING[];
...
extern const char MSG_FILAMENT_PULL_OUT[];
extern const char MSG_FILAMENT_UNLOAD[];
extern const char MSG_FILAMENT_UNLOADING[];
...
extern const char MSG_FSENSOR_LONG[];
...
extern const char MSG_SD_CARD_MENU[];
...
extern const char MSG_SD_SORT[];
extern const char MSG_SD_SORT_ALPHA[];
extern const char MSG_SD_SORT_TIME[];
extern const char MSG_SD_TOSHIBA_AIR[];
