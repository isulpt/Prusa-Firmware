...
//Start: Bed related messages
const char MSG_BED[] PROGMEM_I1 = ISTR("Bed"); ////
const char MSG_BED_DONE[] PROGMEM_I1 = ISTR("Bed done"); ////
const char MSG_BED_FIND_OFFSET_AND_SKEW_LINE1[] PROGMEM_I1 = ISTR("Searching bed calibration point"); ////c=60
const char MSG_BED_FIND_OFFSET_AND_SKEW_LINE2[] PROGMEM_I1 = ISTR(" of 4"); ////c=14
...
const char MSG_BED_MEASURE_REFERENCE_HEIGHT_LINE1[] PROGMEM_I1 = ISTR("Measuring reference height of calibration point"); ////c=60
const char MSG_BED_MEASURE_REFERENCE_HEIGHT_LINE2[] PROGMEM_I1 = ISTR(" of 9"); ////c=14
const char MSG_BED_SKEW_OFFSET_DETECTION_FITTING_FAILED[] PROGMEM_I1 = ISTR("XYZ calibration failed. Please consult the manual."); ////c=20 r=8
//End: Bed related messages
const char MSG_CALIBRATE_Z_AUTO[] PROGMEM_I1 = ISTR("Calibrating Z"); ////c=20 r=2
const char MSG_CONFIRM_NOZZLE_CLEAN[] PROGMEM_I1 = ISTR("Please clean the nozzle for calibration. Click when done."); ////c=20 r=8
const char MSG_COOLDOWN[] PROGMEM_I1 = ISTR("Cooldown"); ////
const char MSG_CRASH_DETECT[] PROGMEM_I1 = ISTR("Crash det."); ////c=13
...
const char MSG_EXTRUDER_CHOOSE[] PROGMEM_I1 = ISTR("Choose extruder:"); ////c=20 r=1
const char MSG_FAN_SPEED[] PROGMEM_I1 = ISTR("Fan speed"); ////c=14
//Start: Filament related messages
const char MSG_FILAMENT[] PROGMEM_I1 = ISTR("Filament"); ////c=17 r=1
const char MSG_FILAMENT_CLEAN[] PROGMEM_I1 = ISTR("Filament extruding & with correct color?"); ////c=20 r=2
const char MSG_FILAMENT_CHANGE[] PROGMEM_I1 = ISTR("Change filament"); ////
const char MSG_FILAMENT_CHOOSE[] PROGMEM_I1 = ISTR("Choose filament:"); ////c=20 r=1
const char MSG_FILAMENT_CUT[] PROGMEM_I1 = ISTR("Cut filament"); //// Number 1 to 5 is added behind text e.g. "Cut filament 1" c=16
const char MSG_FILAMENT_EJECT[] PROGMEM_I1 = ISTR("Eject filament"); //// Number 1 to 5 is added behind text e.g. "Eject filament 1" c=16
const char MSG_FILAMENT_LOAD[] PROGMEM_I1 = ISTR("Load filament"); //// Number 1 to 5 is added behind text e.g. "Load filament 1" c=16
const char MSG_FILAMENT_LOADING[] PROGMEM_I1 = ISTR("Loading filament"); ////c=20
...
const char MSG_FILAMENT_PULL_OUT[] PROGMEM_I1 = ISTR("Please pull out filament immediately"); ////c=20 r=4
const char MSG_FILAMENT_UNLOAD[] PROGMEM_I1 = ISTR("Unload filament"); ////c=17
const char MSG_FILAMENT_UNLOADING[] PROGMEM_I1 = ISTR("Unloading filament"); ////c=20 r=1
//End: Filament related messages
...
//Start: Fsensor related messages
const char MSG_FSENSOR[] PROGMEM_I1 = ISTR("Fil. sensor"); ////
const char MSG_FSENSOR_AUTOLOAD[] PROGMEM_I1 = ISTR("F. autoload"); ////c=13
const char MSG_FSENSOR_LONG[] PROGMEM_I1 = ISTR("Filament sensor"); ////c=17
//End: Fsensor related messages
...
//Start: SD Card related messages
const char MSG_SD_CARD_MENU[] PROGMEM_I1 = ISTR("Print from SD"); ////
//End: SD Card related messages
//Start: Selftest related messages
...
const char MSG_SD_SORT[] PROGMEM_I1 = ISTR("Sort"); ////
const char MSG_SD_SORT_ALPHA[] PROGMEM_I1 = ISTR("Alphabet"); ////
const char MSG_SD_SORT_TIME[] PROGMEM_I1 = ISTR("Time"); ////
const char MSG_SD_TOSHIBA_AIR[] PROGMEM_I1 = ISTR("FlashAir"); ////
